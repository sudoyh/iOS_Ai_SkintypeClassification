...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "com.impactdna.Acos3", account: "IMPACTDNA Inc.").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "com.impactdna.Acos3", account: "IMPACTDNA Inc.").deleteItem()
        } catch {
